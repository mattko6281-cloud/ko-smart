...
//  메타수학용 프롬프트 가이드 원문
// ─────────────────────────────────────────────────────────────
const META_PROMPT_GUIDE = `[TikZ 수학 그래프 렌더링 엄격한 스타일 가이드: 평가원(KICE) 스타일 v2.1 - 20260602]

앞으로 모든 TikZ 수학 그래프 코드를 생성할 때는 한글(HWP) 문서 삽입 후 축소(25% 규격 등) 시 일러스트레이터 파일과 완벽히 동일한 가독성을 확보하고, 웹 에디터의 최적화 환경을 위해 아래의 규칙을 예외 없이 엄격하게 적용하세요.
